...
export const Intro = () => {
    return (
        <section id={'intro'} className={'flex flex-col lg:flex-row justify-center mt-8 items-center'}>

            <div className={'w-full lg:w-3/5 xl:w-4/5 text-center lg:text-left'}>
                <h1 className={'text-center text-2xl sm:text-3xl md:text-4xl xl:text-6xl font-extrabold flex flex-col mb-3 leading-10 md:leading-12 xl:leading-16'}>
                ...
                */}
                <p className={'text-muted-foreground mb-4 text-center'}>
                    Focused on AI-powered applications, cloud architecture, and modern software systems.
                </p>

                <nav className={'flex gap-2 mb-7 lg:mb-0 justify-center flex-wrap'}>
